...
if(!$kluda)
{
	$sql="SELECT `VDIENAS`.`autors`, `VDIENAS`.`datums`, `VDIENAS`.`menesis` FROM `VDIENAS` WHERE (`VDIENAS`.`vards` like '$ko')";
...
{
	echo "<tr>
	<td>".$rezultats[$i]['vards']."</td>
	<td>".$rezultats[$i]['datums']."</td>
	<td>".$rezultats[$i]['menesis']."</td>
